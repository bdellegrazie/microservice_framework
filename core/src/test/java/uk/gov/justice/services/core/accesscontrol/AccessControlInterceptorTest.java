...
import static uk.gov.justice.services.core.interceptor.Interceptor.ACCESS_CONTROL;
...
public class AccessControlInterceptorTest {
    ...
    @Test
    public void shouldApplyAccessControlToSynchronousInputIfLocalComponent() throws Exception {
    ...
    @Test
    public void shouldNotApplyAccessControlToSynchronousInputIfRemoteComponent() throws Exception {
    ...
    public void shouldReturnAccessControlPriority() throws Exception {
        assertThat(accessControlInterceptor.priority(), is(ACCESS_CONTROL));
    }

    @Test
    public void shouldThrowAccessControlViolationExceptionIfAccessControlFailsForSynchronousInput() throws Exception {
