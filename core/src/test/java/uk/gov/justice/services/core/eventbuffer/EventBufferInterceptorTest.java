...
public class EventBufferInterceptorTest {
    ...
    public void shouldProcessStreamOfBufferedEventsAndReturnThefirstInterceptorContext() throws Exception {
        ...
        final InterceptorContext interceptorContext = interceptorContextWith(envelope_1, mock(InjectionPoint.class));
